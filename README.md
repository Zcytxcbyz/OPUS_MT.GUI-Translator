...
| File | Description |
|------|-------------|
| `OPUS-MT.GUI-DOTNET10-x64-WithModels.zip` | Full package including models (~1.6 GB). Extract and run `OPUS-MT.GUI.exe`. |
...
| 文件 | 说明 |
|------|------|
| `OPUS-MT.GUI-DOTNET10-x64-WithModels.zip` | 完整包（含模型），约 1.6 GB。解压后运行 `OPUS-MT.GUI.exe` 即可。 |
